<%@ Page Language="C#" MasterPageFile="~/Template/CMS.Master" AutoEventWireup="true" CodeFile="Product_Edit.aspx.cs" Inherits="Backend_Admin_Product_Product_Edit" ValidateRequest="false" EnableEventValidation="false" %>
                ...
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active"><a>Chỉnh sửa thông tin sản phẩm</a></li>
                                <li class="breadcrumb-item"><a href="../Product/Product_List">Quản lý sản phẩm</a></li>
                                <li class="breadcrumb-item"><a href="/">Trang chủ</a></li>
                            </ol>
                        </div>
                        <h4 class="page-title">Chỉnh sửa thông tin sản phẩm</h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList runat="server" ID="ddlProductBrand" CssClass="form-control select2" data-parsley-required="true" data-parsley-allselected="true" data-parsley-required-message="Chưa chọn danh mục"></asp:DropDownList>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList runat="server" ID="ddlCate" CssClass="form-control select2" data-parsley-required="true" data-parsley-allselected="true" data-parsley-required-message="Chưa chọn thể loại sản phẩm"></asp:DropDownList>
                                    </div>
                                   ...
                                   <div class="form-group">
                                        <div class="row ">
                                            <div class="col-lg-6">
                                                ...
                                                <br />
                                                <div style="margin: 5px 0px;/*position:relative; display:inline-block;*/">
                                                    <%--<span style="position:absolute;top:-5px;right:-5px; padding:5px;background:red;">X</span>--%>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group checkbox checkbox-success">
                                            <asp:CheckBox runat="server" ID="ckStatus" ClientIDMode="Static" Checked="true" Text="Duyệt đăng" />
                                        </div>
                                    </div>
